...
serve(async (req) => {
  ...
  try {
    ...
    // Generate powerful hero image using Lovable AI
    console.log('Generating hero image with Lovable AI...');
    let imageUrl = null;
    let imageCredit = 'AI Generated by Cardinal News (Google Gemini)';
      ...
      const imageResponse = await fetch('https://ai.gateway.lovable.dev/v1/chat/completions', {
        ...
        body: JSON.stringify({
          ...
          messages: [
            {
              role: 'user',
              content: `Create a powerful, professional news hero image for this article: "${articleData.title}". 
              Style: Photorealistic, high-quality journalism photography, cinematic lighting, 16:9 aspect ratio. Ultra high resolution.
