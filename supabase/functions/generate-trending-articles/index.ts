...
Return ONLY a JSON object with this exact structure:
{
  ...
  "meta_keywords": ["keyword1", "keyword2", "keyword3"]
        ...
        // Fallback to AI image generation if no real image found
        if (!imageFetchSuccess) {
          ...
          try {
            ...
            if (!aiError && aiImageData?.success) {
              ...
              usedImagesInBatch.add(imageUrl); // Track AI generated image too
              console.log('✓ Generated unique AI image successfully');
            } else {
